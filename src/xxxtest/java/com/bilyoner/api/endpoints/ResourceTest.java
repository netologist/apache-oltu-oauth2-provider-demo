...
public class ResourceTest extends ClientResourceOAuthTest {
    ...
    public void testResourceAccessBodyValidToken() throws Exception {
        ...
        if (c instanceof HttpURLConnection) {
            ...
            httpURLConnection
                .setRequestProperty("Content-Length", Integer.toString(TestContent.BODY_OAUTH2.length()));
    ...
    public void testResourceAccessBodyExpiredToken() throws Exception {
        ...
        if (c instanceof HttpURLConnection) {
            ...
            httpURLConnection.setRequestProperty("Content-Type", "application/x-www-form-urlencoded");
            httpURLConnection
                .setRequestProperty("Content-Length", Integer.toString(TestContent.BODY_OAUTH2_EXPIRED.length()));
            OutputStream ost = httpURLConnection.getOutputStream();
            PrintWriter pw = new PrintWriter(ost);
    ...
    public void testResourceAccessBodyInsufficientToken() throws Exception {
        ...
        if (c instanceof HttpURLConnection) {
            ...
            httpURLConnection.setRequestProperty("Content-Type", "application/x-www-form-urlencoded");
            httpURLConnection.setRequestProperty("Content-Length",
                Integer.toString(TestContent.BODY_OAUTH2_INSUFFICIENT.length()));
            OutputStream ost = httpURLConnection.getOutputStream();
            PrintWriter pw = new PrintWriter(ost);
    ...
    public void testResourceAccessQueryValidToken() throws Exception {
        ...
        URL url = new URL(
            TestContent.RESOURCE_SERVER + TestContent.PROTECTED_RESOURCE_QUERY + "?" + TestContent.QUERY_OAUTH2);
        URLConnection c = url.openConnection();
